...
<body>
    ...
    <div class="goalTimeContainer">
        ...
        <div class="goalTimeItem">
            ...
            <div class="goalTimeText"><p>運動時間</p><span><%= session.getAttribute("extime") %>時間</span></div>
        </div>
        <!-- 勉強時間 -->
        <div class="goalTimeItem">
            <div class="icon">
            ...
            <div class="goalTimeText"><p>勉強時間</p><span><%= session.getAttribute("sttime") %>時間</span></div>
        </div>
        <!-- 睡眠時間 -->
        <div class="goalTimeItem">
            <div class="icon">
            ...
            <div class="goalTimeText"><p>睡眠時間</p><span><%= session.getAttribute("sltime") %>時間</span></div>
        </div>
        <h1>達成率</h1>
    </div>

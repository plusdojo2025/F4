...
<body>
    ...
    <div class="progressContainer">
        ...
        <div class="progressBar">
            <div class="progressBarFill" style="width: <%= request.getAttribute("level") %>%"></div>
        </div>
        <p><span><%= request.getAttribute("level") %>%</span></p>
    </div>
    ...
    <div class="goalTimeContainer">
        ...
        <div class="goalTimeItem">
            ...
            <div class="goalTimeText"><p>運動時間</p><span><%= request.getAttribute("exercise_goal") %>時間</span></div>
        </div>
        <!-- 勉強時間 -->
        <div class="goalTimeItem">
            <div class="icon">
            ...
            <div class="goalTimeText"><p>勉強時間</p><span><%= request.getAttribute("study_goal") %>時間</span></div>
        </div>
        <!-- 睡眠時間 -->
        <div class="goalTimeItem">
            <div class="icon">
            ...
            <div class="goalTimeText"><p>睡眠時間</p><span><%= request.getAttribute("sleep_goal") %>時間</span></div>
        </div>
    </div>

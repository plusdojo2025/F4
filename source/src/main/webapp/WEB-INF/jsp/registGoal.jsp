	...
	<div class="form">
		<form id="registGoalForm"
			...
			<div class="form-group">
				<input type="number" name="exercise" id="goal-exercise" required
					placeholder=" " /> <label for="goal-exercise">一日の運動時間（推奨1時間）</label>
			</div>

			<div class="form-group">
				<input type="number" name="study" id="goal-study" required
					placeholder=" " /> <label for="goal-study">一日の勉強時間（1〜3時間が効果的）</label>
			</div>

			<div class="form-group">
				<input type="number" name="sleep" id="goal-sleep" required
